...
import 'package:students_mobile/menu.dart';
import 'package:students_mobile/report.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
       appBar: AppBar(backgroundColor: ColorResources.green129,title:const Image(
